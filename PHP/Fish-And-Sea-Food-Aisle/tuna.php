  ...
  <div class="content-container">
    <div class="col-50">
      ...
      <div class="img-container">
        <?php  print('<img src="../../Images/Fish-And-Sea-Food-Aisle/' . $data['products'][23]['image'] . '" alt="' . $value->name . ' Image">');?>
      </div>
    </div>
    <div class="col-50">
      ...
      <form method ="POST" action = "../Order.php">
          ...
          <input type ="hidden" name ="name" value ="Tuna" class ="name">
          <input type ="hidden" value = "<?php echo $data['products'][23]['price']?>" name ="price"> </h3>
