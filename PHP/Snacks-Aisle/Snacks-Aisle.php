...
<body>
  ...
  <section class="banner">
    <img src="../../Images/Snacks-Aisle/snacks.jpeg" alt="Banner Image">
    <h2>Snacks</h2>
  </section>
  <section class="products">
    ...
    foreach ($products as $value) {
      $aisle = $value->aisle;
      if (strcasecmp($aisle, "Snacks-Aisle") == 0) {
        print('
          <div class="fake-margin col">
          <div class="row">
          <img src="../../Images/Snacks-Aisle/' . $value->name . '.png" alt="' . $value->name . ' Image">
          <p>' . $value->name . '<br>
