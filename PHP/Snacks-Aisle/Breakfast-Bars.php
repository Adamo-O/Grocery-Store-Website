    ...
    <div class="container h-100 d-flex flex-column">
      <div class="row h-75 mb-4">
        <div class="col-md-6 col-lg-6 grey" style="margin-top:30px">
          <h2 class ="product"><?php echo $data['products'][29]['name']?></h2>
          <br/>
          <div class ="image">
          <?php  print('<img src="../../Images/Snacks-Aisle/' . $data['products'][29]['image'] . '" alt="' . $value->name . ' Image">');?>
          </div>
        </div> 
        <div class="col-md-6 col-sm-12 col-lg-6 grey" style="margin-top:30px">
          <h3 id="price" class ="price">For only $<?php echo $data['products'][29]['price'];?> / 200g</h3>
          ...
          <input type ="hidden" name ="name" value ="Breakfast Bars" class ="name">
          <input type ="hidden" value = "<?php echo $data['products'][29]['price']?>" name ="price"> </h3>
