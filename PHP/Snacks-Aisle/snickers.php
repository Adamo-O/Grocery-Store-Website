    ...
    <div class="container h-100 d-flex flex-column">
      <div class="row h-75 mb-4">
        <div class="col-md-6 col-lg-6 grey" style="margin-top:30px">
          <h2 class ="product"><?php echo $data['products'][28]['name']?></h2>
          <div class ="image">
          <?php  print('<img src="../../Images/Snacks-Aisle/' . $data['products'][28]['image'] . '" alt="' . $value->name . ' Image">');?>
          </div>
        </div> 
        <div class="col-md-6 col-sm-12 col-lg-6 grey" style="margin-top:30px">
          <h3 class ="price">For only $<?php echo $data['products'][28]['price']?> for 6 full bars</h3>
          ...
          <input type ="hidden" name ="name" value ="Snickers" class ="name">
          <input type ="hidden" value = "<?php echo $data['products'][28]['price']?>" name ="price"> </h3>
          ...
          <button class="btn" class ="cartButton">Add To Cart🛒</button>
        </div>
