    ...
    <div class="container h-100 d-flex flex-column">
      <div class="row h-75 mb-4">
        <div class="col-md-6 col-lg-6 grey" style="margin-top:30px">
          ...
          <br/>
          <div class ="image">
          <?php  print('<img src="../../Images/Snacks-Aisle/' . $data['products'][25]['image'] . '" alt="' . $value->name . ' Image">');?>
          </div>
        </div> 
        <div class="col-md-6 col-sm-12 col-lg-6 grey" style="margin-top:30px">
          <h3 id="price" class ="price">For only $<?php echo $data['products'][25]['price'];?> / 235g</h3>
          ...
          <input type ="hidden" name ="name" value ="Doritos" class ="name">
          <input type ="hidden" value = "<?php echo $data['products'][25]['price']?>" name ="price"> </h3>
