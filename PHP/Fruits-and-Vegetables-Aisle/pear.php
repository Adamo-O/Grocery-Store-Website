...
?>
  ...
  <div class="content-container">
    <div class="col-50">
      <h3><?php echo $data['products'][2]['name']?></h3>
      <div class="img-container">
      <?php  print('<img src="../../Images/Fruits-And-Vegetables-Aisle/' . $data['products'][2]['image'] . '" alt="' . $value->name . ' Image">');?>
      </div>
    </div>
    <div class="col-50">
      ...
      <form method ="POST" action = "../Order.php">
          ...
          <input type ="hidden" name ="name" value ="Pear" class ="name">
          <input type ="hidden" value = "<?php echo $data['products'][2]['price']?>" name ="price"> </h3>
