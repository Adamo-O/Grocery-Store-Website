...
<body>
  ...
  <section class="banner">
    <img src="../../Images/Dairy-Products-Aisle/milk-product.png" alt="Banner Image">
  ...
  <section class="products">
    ...
    foreach ($products as $value) {
      $aisle = $value->aisle;
      if (strcasecmp($aisle, "Dairy-Products-Aisle") == 0) {
        print('
          <div class="fake-margin col">
          <div class="row">
          <img src="../../Images/Dairy-Products-Aisle/' . $value->name . '.png" alt="' . $value->name . ' Image">
          <p>' . $value->name . '<br>
