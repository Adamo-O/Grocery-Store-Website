    ...
    <div class="container d-flex flex-column">
      <div class="row mb-4" id="productContainer">
        <div class="col-md-6 col-lg-6 grey" style="margin-top:30px">
          <h2 class ="product"><?php echo $data['products'][7]['name']?></h2>
          <br/>
          <div class ="image">
          <?php  print('<img src="../../Images/Meat-Aisle/' . $data['products'][7]['image'] . '" alt="' . $value->name . ' Image">');?>
          </div>
        </div> 
        <div class="col-md-6 col-sm-12 col-lg-6 grey" style="margin-top:30px">
          <h3 id ="price" class ="price">For only $<?php echo $data['products'][7]['price']?> per pound</h3>
          ...
          <input type ="hidden" name ="name" value ="Chicken Breast" class ="name">
          <input type ="hidden" value = "<?php echo $data['products'][7]['price']?>" name ="price"> </h3>
