  ...
  <?php require('../navbar.php'); ?>
    <div class="container d-flex flex-column">
      <div class="row mb-4" id="productContainer">
        <div class="col-12 col-md-6 col-lg-6 grey" style="margin-top:30px">
          <h2 class ="product"><?php echo $data['products'][10]['name']?></h2>
          <br/>
          <div class ="image">
          <?php  print('<img src="../../Images/Meat-Aisle/' . $data['products'][10]['image'] . '" alt="' . $value->name . ' Image">');?>
          </div>
        </div> 
        <div class="col-12 col-md-6 col-sm-12 col-lg-6 grey" style="margin-top:30px">
          <h3 id="price" class ="price">For only $<?php echo $data['products'][10]['price'];?> per pound</h3>
          ...
          <input type ="hidden" name ="name" value ="T Bone Steak" class ="name">
          <input type ="hidden" value = "<?php echo $data['products'][10]['price']?>" name ="price"> </h3>
