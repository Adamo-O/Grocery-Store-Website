    ...
    <div class="container h-100 d-flex flex-column">
      <div class="row h-75 mb-4">
        <div class="col-md-6 col-lg-6 grey" style="margin-top:30px">
          ...
          <br/>
          <div class ="image">
          <?php  print('<img src="../../Images/Bakery-Aisle/'. $data['products'][14]['image'] . '.png" alt="' . $value->name . ' Image">');?>
          </div>
        </div> 
        <div class="col-md-6 col-sm-12 col-lg-6 grey" style="margin-top:30px">
          ...
          <div id="descContainerCcc" class="container-sm success shadow bg-success offset-3 p-4" hidden>
            <h6 style="color: white;">Oven baked, sweet and crunchy bites with melted<br/> chocolate inside. A delightful way to start the day!</h6>
            <style>
              table,
              th,
              td {
